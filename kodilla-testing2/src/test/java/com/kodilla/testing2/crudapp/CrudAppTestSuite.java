...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://nikoguj.github.io/";
    ...
    private String createCrudTestTask() throws InterruptedException {
    ...
    private void deleteTestTaskTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().equals(taskName))
                .forEach(theForm -> {
                    WebElement buttonDeleteTask = theForm.findElement(By.xpath(".//fieldset[contains(@class, \"datatable__row-section\")]/button[4]"));
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        String taskName = createCrudTestTask();
